...
class OldInputLogicScript : MonoBehaviour
{
    // Public unity setter
    ...
    OldPlayerControllerScript playerControllerScript;

    void Start()
    {
        // Check for PlayerControllerScript and set to variable
        if (GetComponent<OldPlayerControllerScript>())
            playerControllerScript = GetComponent<OldPlayerControllerScript>();
        else
    ...
    void InputRight() { }
    void InputLeft() { }
    void InputUp() { playerControllerScript.SetMovementPhase(OldMovementPhase.Jump); }
    void InputDown() { playerControllerScript.SetMovementPhase(OldMovementPhase.Slip); }
